---
version: 1.2.0
x-collection-name: Stripe Get Coupons (stream)
info:
  title: Stripe
  version: 1.2.0
servers:
- url: api.stripe.com/coupons
  scheme: https
  asyncapi_servers_variables:
    ...
    created:
      description: A filter on the list based on the object `created` field. The value
        can be a string with an integer Unix timestamp, or it can be a dictionary
...
stream:
  framing:
    ...
    delimiter: \r\n
  read:
  - $ref: '#/components/messages/coupons'
---